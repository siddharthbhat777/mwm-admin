        ...
        <div className={classes.sidebar}>
            ...
            <div className={classes.sidebarContent}>
                <div className={classes.topContent}>
                    ...
                    <div className={`${classes.sidebarTab} ${location.pathname === '/users' && classes.sidebarTabSelected}`} onClick={() => navigate('/users')}>
                    ...
                    <div className={`${classes.sidebarTab} ${location.pathname === '/media' && classes.sidebarTabSelected}`} onClick={() => navigate('/media')}>
                    ...
                    <div className={`${classes.sidebarTab} ${location.pathname === '/category' && classes.sidebarTabSelected}`} onClick={() => navigate('/category')}>
                    ...
                    <div className={`${classes.sidebarTab} ${location.pathname === '/artist' && classes.sidebarTabSelected}`} onClick={() => navigate('/artist')}>
