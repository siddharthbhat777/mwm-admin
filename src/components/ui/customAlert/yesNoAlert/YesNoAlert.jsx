...
import classes from './YesNoAlert.module.css';
import { motion } from 'framer-motion';

function YesNoAlert({ message, onClose, onSubmit }) {
    return (
        <div className={classes.customAlert}>
            <motion.div initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.1 }} className={classes.customAlertContent}>
                ...
                <div className={classes.bottomContent}>
                    ...
                    <div className={classes.yesNoButtons}>
                        <button className={classes.customAlertOkButton} onClick={onSubmit}>Yes</button>
                        <button className={classes.customAlertOkButton} onClick={onClose}>No</button>
                    </div>
                </div>
            </motion.div>
        </div>
