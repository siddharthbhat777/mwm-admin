...
import classes from './DetailsDropdownNoKey.module.css';

const DetailsDropdownNoKey = ({ defaultText, options, onSelect }) => {
    ...
    const handleOptionClick = (option) => {
        setSelectedOption(option.header);
        setIsOpen(false);
        onSelect(option.key);
    };
...
export default DetailsDropdownNoKey;